...
st.markdown("""
    ...
    .stButton>button { border-radius: 10px; font-weight: bold; height: 50px; width: 100%; border: 1px solid #333; transition: 0.3s; }
    .stButton>button:hover { border: 1px solid #00ff41; box-shadow: 0px 0px 10px #00ff41; }
    div[data-testid="stMetricValue"] { color: #00ff41; }
    .wa-btn { background-color: #25D366; color: white !important; padding: 12px; text-decoration: none; border-radius: 10px; display: block; text-align: center; font-weight: bold; margin-top: 10px; }
    </style>
...
# Yahan error aa raha tha, ab fix hai:
...
with col_bill:
    ...
    if current_order:
        ...
        st.info("No items added yet. Select a table and add items from the menu.")
